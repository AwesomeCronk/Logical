...
nuitka --standalone --onefile --include-data-file=Logical.version.txt=Logical.version.txt --include-data-file=LICENSE=LICENSE --include-data-file=README.md=README.md "$program.py" #Build with Nuitka
